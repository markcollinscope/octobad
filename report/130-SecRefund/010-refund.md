...
Octopus Energy has consistently overestimated gas usage on this account since its inception, as evidenced by the annual consumption estimates included in each bill (see ApxAnnualEstimates).
...
Despite multiple requests (see AppRefundEmails) and the supplementary questions detailed herein, no explanation has been provided.
...
Initially, responses indicated that clarification would be provided. This was followed by responses stating that access to the account/system was not available, and ultimately no further explanation was given (see XXXRefEmailsInitialResponse and XXXRefEmailsNoAccess).
...
(See ApxAppGasReadingsUpDown)

#### XXX - A Year Ago inaccuracies.

---

#### - Questions put to and ignored by Octopus - XXXX
...
- Compensation for time and effort (see separate section XXX)  
...
See the following appendices in relation to this section:

* ApxRefundBills
* ApxRefundEmails
* ApxAnnualEstimates
* ApxAppGasReadingsUpDown
