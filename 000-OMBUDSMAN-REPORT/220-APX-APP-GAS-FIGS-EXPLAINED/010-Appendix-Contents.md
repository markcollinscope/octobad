...
*   Speadsheet showing the (somewhat convoluted) mapping between the App Readings (see last point) the origins of the values in RefRefundedBill1, RefRefundedBill2 and RefRefundBill.
...
![Caption](030-AppGasReadingsUpAndDown.png){ width=90% }
